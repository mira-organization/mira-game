...
use bevy::prelude::*;
use crate::logic::loading::pipeline_check::checker::{PipelineCheckPlugin, PipelinesReady};
...
impl LoadingData {
    pub fn new(confirmation_frames_target: usize, total_assets: usize) -> Self {
        Self {
            assets: Vec::new(),
...
impl Plugin for LoadingHandlerPlugin {
    fn build(&self, app: &mut App) {
        app.insert_resource(LoadingData::new(5, 0))
